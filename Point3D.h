...
public:
  ...
  inline void allignSpine(double xshift, double yshift,double zshift){x -= xshift; y-= yshift; z-= zshift;}
  inline void scalePoints(double scale){x *= scale; y *= scale; z *= scale;}
protected:
